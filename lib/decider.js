 ...
 * @fires Poller#error
 */
var Decider = exports.Decider = function (config, swfClient, logger) {

    this.loger = logger || console;
...
Decider.prototype._onNewTask = function(originalResult,result,_this, events) {
    ...
    if(result.nextPageToken) {
        ...
        var decisionTask = new DecisionTask(originalResult, this.swfClient,events, this.logger);
